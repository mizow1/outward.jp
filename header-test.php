...
<link rel="stylesheet" type="text/css" href="<?php bloginfo( 'template_url' ); ?>/css/_style.css" />
...
<!-- ▼google APIキー -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCYrmb_J1jaY386lC9n_e8snoAPnZlSiwU"></script>
<!-- ▲google APIキー -->
