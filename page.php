	...
	// スラッグを取得
		...
		<div class="main">
	      ...
	      <div class="main_screen_wrapper">
	        <h2 class="main_img">
	          <img class="pc_inline" src="<?php bloginfo( 'template_url' ); ?>/img/main_screen_<?php echo $parent_slug; ?>.png" alt="<?php the_title(); ?>">
	          <img class="sp_inline" src="<?php bloginfo( 'template_url' ); ?>/img/main_screen_<?php echo $parent_slug; ?>_sp.png" alt="<?php the_title(); ?>">
	        </h2>
	        <div class="main_text_block">
	          <p class="main_text_top"><?php echo $parent_slug ; ?></p>
	          <p class="main_text_btm"><?php echo $parent_title ; ?></p>
	        </div>
	      </div>
	      <nav class="bread">
					<div class="wrapper">
